...
$display("IDLE STATE FAIL : TX = %b", TX_OUTPUT_tb);
...
$display("START_BIT FAIL : TX = %b", TX_OUTPUT_tb);
...
$display("DATA_BIT_0 WITH NO PARITY  STATE FAIL : TX = %b", TX_OUTPUT_tb);
...
$display("DATA_BIT_1 WITH NO PARITY  STATE FAIL : TX = %b", TX_OUTPUT_tb);
...
$display("DATA_BIT_2 WITH NO PARITY  STATE FAIL : TX = %b", TX_OUTPUT_tb);
...
$display("DATA_BIT_3 WITH NO PARITY  STATE FAIL : TX = %b", TX_OUTPUT_tb);
...
$display("DATA_BIT_4 WITH NO PARITY  STATE FAIL : TX = %b", TX_OUTPUT_tb);
...
$display("DATA_BIT_5 WITH NO PARITY  STATE FAIL : TX = %b", TX_OUTPUT_tb);
...
$display("DATA_BIT_6 WITH NO PARITY  STATE FAIL : TX = %b", TX_OUTPUT_tb);
...
$display("DATA_BIT_7 WITH NO PARITY  STATE FAIL : TX = %b", TX_OUTPUT_tb);
...
$display("STOP_BIT FAIL : TX = %b", TX_OUTPUT_tb);
...
$display("DATA_BIT_0 WITH PARITY  STATE FAIL : TX = %b", TX_OUTPUT_tb);
...
$display("DATA_BIT_1 WITH PARITY  STATE FAIL : TX = %b", TX_OUTPUT_tb);
...
$display("DATA_BIT_2 WITH PARITY  STATE FAIL : TX = %b", TX_OUTPUT_tb);
...
$display("DATA_BIT_3 WITH PARITY  STATE FAIL : TX = %b", TX_OUTPUT_tb);
...
$display("DATA_BIT_4 WITH PARITY  STATE FAIL : TX = %b", TX_OUTPUT_tb);
...
$display("DATA_BIT_5 WITH PARITY  STATE FAIL : TX = %b", TX_OUTPUT_tb);
...
$display("DATA_BIT_6 WITH PARITY  STATE FAIL : TX = %b", TX_OUTPUT_tb);
...
$display("DATA_BIT_7 WITH PARITY  STATE FAIL : TX = %b", TX_OUTPUT_tb);
...
$display(" PARITY Bit FAIL TX = %b", TX_OUTPUT_tb);
